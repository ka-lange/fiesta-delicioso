  ...
  return (
    <div className="Home bg-pink">
        ...
        <section className="h-96 home-cover flex flex-col justify-center items-center">
            ...
            <a href="/menu"><button className="bg-teal text-sky w-40 h-10 mt-20" type="button">SEE OUR MENU</button></a>
        </section>
        <section className="py-10 bg-teal flex flex-col justify-center items-center">
            <h3 className="font-slab text-4xl text-red pb-4 border-b-8 border-dotted border-sky">Savor the Spice, Taste the Fiesta </h3>
