        ...
        <div className="bg-red">
            ...
            <div className="flex flex-col items-center">
                ...
                <div className='flex text-sky'>
                    ...
                    <a href="https://www.linkedin.com/in/ka-lange/" target="_blank" className='m-2' title="Karissa Lange LinkedIn">
                    ...
                    <a href="https://github.com/ka-lange" target="_blank" className='m-2' title="Karissa Lange GitHub">
